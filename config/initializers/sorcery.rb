...
Rails.application.config.sorcery.configure do |config|
  ...
  if Rails.env.production?
    config.facebook.key = "1450761228484770"
    config.facebook.secret = "9712c1c1f6a280cdea80fa2113c39305"
    config.facebook.callback_url = "http://morning-earth-3576.herokuapp.com/oauth/callback?provider=facebook"
  else
    config.facebook.key = "1419003044999680"
    config.facebook.secret = "647e44212da30cf5a60e1f83e0c2c529"
